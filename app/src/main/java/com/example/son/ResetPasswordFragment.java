                             ...
                             if(task.isSuccessful()){
                                 ...
                                 scaleAnimation.setAnimationListener(new Animation.AnimationListener() {
                                     ...
                                     public void onAnimationEnd(Animation animation) {
                                         emailIconText.setText("Mail başarıyla gönderildi. Lütfen gelen kutunuzu kontrol ediniz.");
                                     ...
                                     public void onAnimationRepeat(Animation animation) {
                                         emailIcon.setImageResource(R.drawable.ic_sendyesil);
                                     }
                                 });
                                 ...
                                 emailIconText.setText("Geçersiz email!");
                                 emailIconText.setTextColor(getResources().getColor(R.color.kirmizi));
                                 TransitionManager.beginDelayedTransition(emailIconContainer);
                                 emailIconText.setVisibility(View.VISIBLE);
                             }
